...
export default function TestDrive() {
  ...
  return (
    <div className="p-4">
      <h1 className="text-xl font-bold mb-4">Test Drives</h1>
        ...
        <tbody>
          {currentItems.map((td, index) => (
            <tr key={td._id} className="text-center">
              ...
              <td className="border px-4 py-2">{td.firstName} {td.lastName}</td>
              <td className="border px-4 py-2">{td.email}</td>
              <td className="border px-4 py-2">{td.phone}</td>
